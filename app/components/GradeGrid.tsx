      ...
      <div className="flex flex-nowrap justify-center gap-4 max-w-4xl mx-auto">
        ...
        {['Grade 2', 'Grade 3', 'Grade 4', 'Grade 5'].map((grade) => (
          <button
            ...
            className="bg-bark/40 border-2 border-bark/30 text-charcoal/60 font-bold text-lg px-6 py-8 rounded-xl flex-1 text-left hover:bg-bark/50 transition-colors"
          >
            <div>{grade}</div>
